...
add_noise_and_save_images(covid_image_paths, output_path, validation_set_path, noise_type='gaussian', sigma=25)

# Process and save noisy non-covid images with Gaussian noise
print("\nProcessing and saving Non-COVID images with Gaussian noise:")
add_noise_and_save_images(non_covid_image_paths, output_path, validation_set_path, noise_type='gaussian', sigma=25)
...
add_noise_and_save_images(covid_image_paths, output_path, validation_set_path, noise_type='salt_and_pepper', salt_prob=0.05, pepper_prob=0.05)
...
add_noise_and_save_images(non_covid_image_paths, output_path, validation_set_path, noise_type='salt_and_pepper', salt_prob=0.05, pepper_prob=0.05)
