...
# Web-app
* The model is already deployed for prediciton using 2D grayscale images at slices level [here](https://kenanmorani-covid-19deployment-pipeline-app-82q4v6.streamlit.app/)
